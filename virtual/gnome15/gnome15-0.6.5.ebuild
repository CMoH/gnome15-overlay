...
DEPEND=""
RDEPEND="      =app-misc/gnome15-core-0.6.5
ayatana?     ( =app-misc/gnome15-indicator-0.0.2 )
g19d?        ( =app-misc/g19d-0.0.10 )
gnome?       ( =app-misc/gnome15-gnome-plugins-0.0.6
			   =app-misc/gnome15-panel-applet-0.0.2 )
lg4l-module? ( =sys-kernel/lg4l-kernel-module-20110523 )
pulseaudio?  ( =app-misc/gnome15-impulse15-0.0.7 )
