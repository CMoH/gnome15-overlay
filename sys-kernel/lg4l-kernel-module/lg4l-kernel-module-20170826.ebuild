...
EGIT_COMMIT="3b92a1b641824e649d1847aa650a0808574db0b0"
...
MODULE_NAMES="hid-gcore(extra) hid-g13(extra) hid-g15(extra) hid-g19(extra) hid-g110(extra) hid-gfb(extra)"

pkg_setup() {
	if kernel_is lt 4 12 0; then
		echo
		ewarn "Your kernel version is ${KV_MAJOR}.${KV_MINOR}.${KV_PATCH}"
		ewarn "This module works with a kernel version >= 4.12.0"
		echo
